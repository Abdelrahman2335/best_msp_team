    ...
    return Scaffold(
      body: Column(
        children: [
          Container(
            child: Image.asset(
              "assets/images/Course app-pana 1.png",
              width: SizeConfig.horizontalBlock * 376,
              height: SizeConfig.verticalBlock * 376,
            ),
            margin: EdgeInsets.only(
                top: SizeConfig.horizontalBlock * 187,
                left: SizeConfig.verticalBlock * 26,
                right: SizeConfig.verticalBlock * 26),
          ),
          Container(
